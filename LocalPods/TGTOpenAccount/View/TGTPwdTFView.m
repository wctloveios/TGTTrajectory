...
- (UIButton *)tgt_pwdBtn {
    if (!_tgt_pwdBtn) {
        ...
        [_tgt_pwdBtn setImage:[UIImage tgt_openAccountImageName:@"tgt_btn_eyes_close"] forState:UIControlStateNormal];
        [_tgt_pwdBtn setImage:[UIImage tgt_openAccountImageName:@"tgt_btn_eyes_open"] forState:UIControlStateSelected];
